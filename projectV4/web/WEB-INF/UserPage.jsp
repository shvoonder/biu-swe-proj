...
<tr>
    ...
    <td>
        <form action="UserPage" method="POST">
            <input type="hidden" name="task" value="<%=t.getId()%>" />
            <input type="hidden" name="new_status" value="<%if((t.getStatus() == 0)){%>1<%}%><%if((t.getStatus() == 1)){%>0<%}%>" />
            <input class="w3-button w3-circle  w3-small w3-theme" type="submit" value="Submit request" />
        </form>
    </td>
</tr>
<%}%>
