...
<link href="css/InvestorSignUpError.css" rel="stylesheet" type="text/css"/>
...
<!-- <input type="submit" id="submit" value="submit" onclick="checkPsw()"> CHECK WHAT IS NEEDED HERE (Eyal 02.03)-->
<!-- <a href="Login.jsp" class="button" onclick="checkPsw()">Submit</a> -->
</div>
</form>
<script>
function check() {
