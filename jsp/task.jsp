...
<div class="w3-card white w3-row-padding w3-container ">
    <ul class="w3-ul w3-border-top">
        ...
        <table class="w3-table w3-striped w3-bordered scrollWindows ">
            ...
            <tbody>
            <tr>
                <td>&nbsp &nbsp &nbsp &nbsp &nbsp <button class="w3-btn w3-white" onclick="move()">SubTask</button>
</div></td>
    ...
    <div class="w3-row">
        <div class="w3-left">
            ...
            <div class="w3-col m10 w3-container">
                <h4>noam <span class="w3-opacity w3-medium">relventTime</span></h4>
                <p>ronen and yarin have to finish there taskes until next monday.</p><br>
            </div>
        </div>
    </div>
    <br>
